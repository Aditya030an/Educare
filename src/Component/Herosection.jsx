...
//   return (
//     <>
//       <div ref={cursorRef} className="fixed w-8 h-8 bg-white rounded-full pointer-events-none mix-blend-difference"></div>
//       <div ref={cursorDotRef} className="fixed w-3 h-3 bg-blue-400 rounded-full pointer-events-none"></div>
...
//           <div className="relative z-10 flex flex-col-reverse md:flex-row items-center gap-10 max-w-7xl w-full">
//             <div className="md:w-1/2 text-center md:text-left space-y-6">
//               <h1 ref={headingRef} className="text-5xl md:text-7xl font-extrabold text-gray-900">
//                 Modern <span className="text-blue-600">ERP</span> Solution
//                 <br />for Your <span className="text-blue-500">School</span>
//               </h1>
...
//               <div
//                 ref={flareRef}
//                 className="absolute top-0 left-0 w-full h-full pointer-events-none bg-gradient-to-tr from-white/40 to-transparent opacity-0 mix-blend-screen rounded-3xl"
//               />
//             </div>
//           </div>
//         </section>
